...
| Arch    | Platform | Available Versions | Available Sites    |
|---------|----------|--------------------|--------------------|
| `arm32` | Linux    | `current`          | Utah               |
| `arm64` | Linux    | `current`          | Utah               |
| `arm64` | macOS    | `8.0-current`      | Utah, Northwestern |
| `arm64` | Windows  | `8.14-current`     | Utah               |
